# Obsidian Merriam-Webster Plugin

This plugin integrates the Merriam-Webster Dictionary and Thesaurus services into Obsidian.
It is written in TypeScript and bundles using `esbuild`.

At this stage of development the plugin provides a settings tab where you can store
